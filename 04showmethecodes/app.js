...
// use anchor tag to go to home page
const Title=() =>{
  return (
    <a href="/">
    <img className="logo"
  ...
  // we need to have one parent element inside the JSX expression
  // const Applayout =() => (
  ...
  // const JSX = <h1>JSX</h1>// valid

  
  
  // const JSX = <h1>JSX</h1><h1>Second JSX</h1>// invalid
...
// applying style to JSX.Inline styling in react
  ...
  // some ppl give styling like this also
  // const JSX =(
  //   <div style={{
  //     backgroundColor:"red",
...
//   return (
//     <div className="card">
//       <img  src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/kp586okorqfweuvauhtv"/>
//       <h2>Burger King</h2>
...
// lets make our data more dynamic
const burgerKing = [
  {
     image:"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/56c9ab92bd79745fd152a30fa2525426",
     name:"Burger King",
...
//     <img 
//     src={
//       "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +restrautList[1].data?.cloudinaryImageId
//   } 
//     />
//     <h2>{restrautList[1].data.name}</h2>
//     <h3>{restrautList[1].data?.cuisines.join(',')}</h3>
//     <h4>{restrautList[1].data?.lastMileTravel} minutes</h4>
...
// lets make our cards more dynamic using props
...
//     <img 
//     src={
//       "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +props.rest.data?.cloudinaryImageId
//   } 
//     />
//     <h2>{props.rest.data.name}</h2>
//     <h5>{props.rest.data?.cuisines.join(',')}</h5>
//     <h4>{props.rest.data?.lastMileTravel} minutes</h4>
...
//     <img 
//     src={
//       "https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +rest.data?.cloudinaryImageId
//   } 
//     />
//     <h2>{rest.data.name}</h2>
//     <h5>{rest.data?.cuisines.join(',')}</h5>
//     <h4>{rest.data?.lastMileTravel} minutes</h4>
...
// destructure the "rest" also 
// const RestrauntCard = ({rest}) =>{
//   console.log(rest);
//   const { name,cuisines,cloudinaryImageId,lastMileTravel } = rest.data;
//   return (
//     <div className = "card"> 
//     <img 
//     src={
...
// if i want to destructure everything on the fly
...
// lets make our card more dynamic using props
// const Body = () => {
//   return (
//     <div className="restaurant-list">
//       <RestrauntCard rest = {restrautList [0]}  hello="world"/>
   
//       <RestrauntCard rest = {restrautList [1]} />
//       <RestrauntCard rest = {restrautList [2]} />
//       <RestrauntCard rest = {restrautList [3]} />
//       <RestrauntCard rest = {restrautList [4]} />
//       <RestrauntCard rest = {restrautList [5]} />
//       <RestrauntCard rest = {restrautList [6]} />
//       <RestrauntCard rest = {restrautList [7]} />
//       <RestrauntCard rest = {restrautList [8]} />
//       <RestrauntCard rest = {restrautList [9]} />
//       <RestrauntCard rest = {restrautList [10]} />
//       <RestrauntCard rest = {restrautList [11]} />
...
// destructuring on the fly.it wont work
// const Body = () => {
//   return (
//     <div className="restaurant-list">
//       <RestrauntCard rest = {restrautList [0].data}  hello="world"/>
   
//       <RestrauntCard rest = {restrautList [1].data} />
//       <RestrauntCard rest = {restrautList [2].data} />
//       <RestrauntCard rest = {restrautList [3].data} />
//       <RestrauntCard rest = {restrautList [4].data} />
//       <RestrauntCard rest = {restrautList [5].data} />
//       <RestrauntCard rest = {restrautList [6].data} />
//       <RestrauntCard rest = {restrautList [7].data} />
//       <RestrauntCard rest = {restrautList [8].data} />
//       <RestrauntCard rest = {restrautList [9].data} />
//       <RestrauntCard rest = {restrautList [10].data} />
//       <RestrauntCard rest = {restrautList [11].data} />
...
//   return (
//     <div className="restaurant-list">
//       <RestrauntCard name = {restrautList [0].data.name} cuisines = {restrautList [0].data.cuisines} cloudinaryImageId = {restrautList [0].data.cloudinaryImageId}
//       lastMileTravel= {restrautList[0].data.lastMileDistance} />
    ...
    <div className="restaurant-list">
      {
        restrautList.map((resto) => {
          return <RestrauntCard {...resto.data} />
        })
      }
